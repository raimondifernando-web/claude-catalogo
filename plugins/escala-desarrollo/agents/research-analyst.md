...
model: sonnet
origen: publicado por Orquesta 2026-09-23 junto con la skill research-deep-dive, que lo orquesta
---
...
- `research-deep-dive` — **Skill Chain**: research-analyst → data-researcher → knowledge-synthesizer. Usar cuando el usuario pida investigación exhaustiva con validación de fuentes primarias y síntesis accionable.
- `market-research-reports` — Reportes de mercado estilo McKinsey/BCG
- `customer-research` — Investigación de audiencia, VOC, personas
- `notion-research-documentation` — Documentar research en Notion
