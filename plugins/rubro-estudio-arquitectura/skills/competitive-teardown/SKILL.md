...
2. **Collect data** — Gather raw signals from at least 3 sources per competitor (website, reviews, job postings, SEO, social).
...
4. **Generate outputs** — Populate the templates (Feature Matrix, Pricing Analysis, SWOT, Positioning Map, UX Audit).
...
Capture recent mentions via Twitter/X, Reddit, or LinkedIn. Look for recurring praise, complaints, and feature requests.
...
For each competitor: 3–5 bullets per quadrant (Strengths, Weaknesses, Opportunities for us, Threats to us). Anchor every bullet to a data signal.

### Positioning Map

2x2 axes (e.g., Simple ↔ Complex / Low Value ↔ High Value). Place each competitor and your product. Bubble size = market share or funding.

### UX Audit Checklist

Onboarding: TTFV (minutes), steps to activation, CC-required, onboarding wizard quality.
Key workflows: steps, friction points, comparative score.
...
7. **Our Action Plan** — Quick wins, medium-term, strategic priorities
